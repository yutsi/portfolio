    ...
    <Container>
      <Row sm='auto' className='justify-content-center skills-content pt-4'>
        <ul className='no-bullets'>
          <li><b>Languages</b>: TypeScript/JavaScript, Python, Java</li>
